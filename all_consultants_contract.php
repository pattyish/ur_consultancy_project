...
{
    var allCompletedConsultancy = $("#totalCompletedConsultancy").val();
    $("#showTotalCplt").html(allCompletedConsultancy);
});
</script>
            ...
            <div class="col-md-12">
                <div class="box" style="padding-left: 5px; padding-right: 5px;">
                    <div class="box-header"
                        ...
                        <h3 class="box-title" style="padding-top: 10px; padding-bottom: 10px;">Consultants contracts &nbsp;<span class="pull-right-container">
                                <small class="label pull-right bg-blue" id="showTotalCplt"></small>
                            </span></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="completed_consultancy" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php include 'backend/allContracts.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
