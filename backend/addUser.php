...
else
{
    ...
    $Insert = $connect ->prepare("INSERT INTO users(user_first_name,user_last_name,user_gender,user_national_id,user_email,user_password,user_status_id,user_type_id,user_profile_image,user_adder_id)
     VALUES(?,?,?,?,?,?,?,?,?,?)");
