...
-- -----------------------------------------------------
-- Schema hfriendz_Consultancy
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema hfriendz_Consultancy
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hfriendz_Consultancy` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `hfriendz_Consultancy` ;

-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`user_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`user_type` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`status` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`users` (
  ...
  CONSTRAINT `users.status`
    ...
    REFERENCES `hfriendz_Consultancy`.`status` (`status_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `users.user_type`
    FOREIGN KEY (`user_type_id`)
    REFERENCES `hfriendz_Consultancy`.`user_type` (`user_type_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `users.users.adder`
    FOREIGN KEY (`user_adder_id`)
    REFERENCES `hfriendz_Consultancy`.`users` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`message_read`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`message_read` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`message`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`message` (
  ...
  CONSTRAINT `message.reads`
    ...
    REFERENCES `hfriendz_Consultancy`.`message_read` (`message_read_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`country` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`client`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`client` (
  ...
  CONSTRAINT `client.country`
    ...
    REFERENCES `hfriendz_Consultancy`.`country` (`country_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`consultancy_progress`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`consultancy_progress` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`consultancy`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`consultancy` (
  ...
  CONSTRAINT `consultancy.client`
    ...
    REFERENCES `hfriendz_Consultancy`.`client` (`client_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `consultancy.progress`
    FOREIGN KEY (`consultancy_progress`)
    REFERENCES `hfriendz_Consultancy`.`consultancy_progress` (`consultancy_progress_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`consultant_contract`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`consultant_contract` (
  ...
  CONSTRAINT `contract.consultancy`
    ...
    REFERENCES `hfriendz_Consultancy`.`consultancy` (`consultancy_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`campus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`campus` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`college`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`college` (
  ...
  CONSTRAINT `college.campus`
    ...
    REFERENCES `hfriendz_Consultancy`.`campus` (`campus_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`school`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`school` (
  ...
  CONSTRAINT `school.college`
    ...
    REFERENCES `hfriendz_Consultancy`.`college` (`college_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`department` (
  ...
  CONSTRAINT `department.school`
    ...
    REFERENCES `hfriendz_Consultancy`.`school` (`school_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`reset_password`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`reset_password` (
...
-- -----------------------------------------------------
-- Table `hfriendz_Consultancy`.`block_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hfriendz_Consultancy`.`block_user` (
